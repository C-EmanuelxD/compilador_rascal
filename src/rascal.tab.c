...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declaracao_var_vazio = 46,      /* declaracao_var_vazio  */
  YYSYMBOL_declaracao_subrotina_vazio = 47, /* declaracao_subrotina_vazio  */
  YYSYMBOL_secao_declaracao_variaveis = 48, /* secao_declaracao_variaveis  */
  YYSYMBOL_repeticao_declaracao = 49,      /* repeticao_declaracao  */
  YYSYMBOL_declaracao_vars = 50,           /* declaracao_vars  */
  YYSYMBOL_lista_identificadores = 51,     /* lista_identificadores  */
  YYSYMBOL_tipo = 52,                      /* tipo  */
  YYSYMBOL_secao_declaracao_subrotinas = 53, /* secao_declaracao_subrotinas  */
  YYSYMBOL_declaracao_subrotina = 54,      /* declaracao_subrotina  */
  YYSYMBOL_procedimento = 55,              /* procedimento  */
  YYSYMBOL_funcao = 56,                    /* funcao  */
  YYSYMBOL_parametros_gerais_subrotina = 57, /* parametros_gerais_subrotina  */
  YYSYMBOL_lista_parametros = 58,          /* lista_parametros  */
  YYSYMBOL_secao_parametros = 59,          /* secao_parametros  */
  ...
  YYSYMBOL_chamada_procedimento = 70,      /* chamada_procedimento  */
  YYSYMBOL_condicional = 71,               /* condicional  */
  YYSYMBOL_repeticao = 72,                 /* repeticao  */
  YYSYMBOL_leitura = 73,                   /* leitura  */
  YYSYMBOL_escrita = 74,                   /* escrita  */
  YYSYMBOL_lista_expressoes_vazio = 75,    /* lista_expressoes_vazio  */
  YYSYMBOL_lista_expressoes = 76           /* lista_expressoes  */
};
...
{
       0,   101,   101,   113,   121,   121,   122,   122,   136,   138,
     143,   150,   156,   161,   168,   169,   173,   177,   181,   181,
     183,   198,   213,   214,   216,   220,   224,   229,   237,   244,
     248,   254,   255,   256,   257,   258,   259,   260,   261,   263,
     268,   269,   274,   275,   276,   277,   278,   279,   282,   283,
     284,   285,   286,   287,   290,   291,   292,   293,   296,   300,
     305,   306,   307,   308,   309,   311,   318,   321,   325,   329,
     334,   340,   341,   344,   348
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_MAIORIGUAL", "T_MAIS", "T_MENOS", "T_VEZES", "T_NUM", "T_ID",
  "LOWER_THAN_ELSE", "$accept", "programa", "bloco",
  ...
  "atribuicao", "expressao", "relacao", "expressao_simples", "termo",
  "fator", "chamada_procedimento", "condicional", "repeticao", "leitura",
  "escrita", "lista_expressoes_vazio", "lista_expressoes", YY_NULLPTR
};
...
{
      19,   -25,    30,    15,   -76,    36,     9,    40,    55,   -76,
     -76,     9,    32,     0,   -76,    34,    47,    82,    55,    63,
     -76,   -76,    66,   -76,    46,    50,    64,    64,     2,   -76,
      69,   -76,   -76,   -76,   -76,   -76,   -76,     9,    70,    71,
      33,    33,    67,    72,     7,   -76,     8,   -76,   -76,   -76,
     -76,   -76,   -76,   -76,   -76,    13,    -5,   -76,    36,    46,
      44,   -76,   -76,    33,    44,    44,   -76,    73,    87,    45,
      -8,   -76,    85,     9,    33,    33,    33,   -76,     2,    46,
       9,   -76,    82,   -76,    75,   -76,    74,    -8,    -8,    33,
       2,    44,   -76,   -76,   -76,   -76,   -76,   -76,    44,    44,
      33,    44,    44,    44,     2,    28,   -76,    76,    77,    78,
     -76,   -76,   -76,   -76,   -76,    36,   -76,    79,    91,    -8,
      -8,    -8,    -4,   -76,   -76,   -76,   -76,   -76,   -76,    33,
     -76,   -76,   -76,     2,   -76,   -76
};
...
static const yytype_int8 yydefact[] =
{
      ...
      18,    19,     0,     9,     0,     0,    22,    22,    38,     3,
       0,    16,    10,    15,    14,    11,    13,     0,     0,     0,
       0,     0,     0,     0,     0,    37,     0,    29,    31,    32,
      33,    34,    35,    36,    17,     0,     0,    24,     4,     0,
       0,    61,    62,     0,     0,     0,    60,    58,     0,    40,
      48,    54,     0,     0,    71,    71,     0,    28,    38,     0,
       0,    23,     0,    20,     0,    64,     0,    49,    50,    71,
      38,     0,    42,    43,    44,    45,    46,    47,     0,     0,
       0,     0,     0,     0,    38,     0,    73,     0,    72,     0,
      39,    30,    26,    25,    27,     4,    63,     0,    66,    53,
      51,    52,    41,    57,    56,    55,    68,    69,    70,     0,
      65,    21,    59,    38,    74,    67
};
...
{
     -76,   -76,   -76,   101,   -76,   -76,   -76,    98,   -32,   -51,
     -76,    92,   -76,   -76,    84,   -76,    35,    -3,   -15,   -76,
     -75,   -76,   -40,   -76,    14,   -47,   -56,   -76,   -76,   -76,
     -76,   -76,   -63,   -76
};
...
{
       0,     2,     7,    82,    17,     9,    11,    12,    13,    35,
      18,    19,    20,    21,    38,    56,    57,    83,    45,    46,
      47,    48,   106,   100,    69,    70,    71,    49,    50,    51,
      52,    53,   107,   108
};
...
{
      68,    72,    29,   111,    85,    55,    28,   101,    84,   102,
      91,    40,   109,    77,    41,   118,     3,    87,    88,    80,
      42,    43,     1,    86,    81,    24,   117,    25,   112,   126,
       4,   103,    78,    98,    99,    75,   110,    76,    79,     5,
      25,   105,     6,    44,   119,   123,   124,   125,    55,    60,
      10,   120,   121,    61,    62,    25,    23,   127,   135,    91,
      60,    63,    15,    16,    61,    62,    14,   114,    33,    34,
      64,    65,    63,    66,    67,    26,    92,    93,    94,    95,
      96,    97,    98,    99,    66,    67,    28,    31,    27,   134,
      32,    36,    37,    54,    58,    73,    59,    90,   104,   115,
      74,    89,   133,   116,   129,   128,     8,   130,   132,    22,
      30,    39,   131,     0,   122,   113
};

static const yytype_int16 yycheck[] =
{
      40,    41,    17,    78,    60,    37,     4,    15,    59,    17,
      14,     9,    75,     5,    12,    90,    41,    64,    65,    24,
      18,    19,     3,    63,    29,    25,    89,    27,    79,   104,
       0,    39,    24,    37,    38,    28,    76,    30,    25,    24,
      27,    73,     6,    41,    91,   101,   102,   103,    80,    16,
      41,    98,    99,    20,    21,    27,    24,    29,   133,    14,
      16,    28,     7,     8,    20,    21,    26,    82,    22,    23,
      37,    38,    28,    40,    41,    41,    31,    32,    33,    34,
      35,    36,    37,    38,    40,    41,     4,    24,    41,   129,
      24,    41,    28,    24,    24,    28,    25,    10,    13,    24,
      28,    28,    11,    29,    27,    29,     5,    29,    29,    11,
      18,    27,   115,    -1,   100,    80
};
...
{
       0,     3,    44,    41,     0,    24,     6,    45,    46,    48,
      41,    49,    50,    51,    26,     7,     8,    47,    53,    54,
      55,    56,    50,    24,    25,    27,    41,    41,     4,    61,
      54,    24,    24,    22,    23,    52,    41,    28,    57,    57,
       9,    12,    18,    19,    41,    61,    62,    63,    64,    70,
      71,    72,    73,    74,    24,    51,    58,    59,    24,    25,
      16,    20,    21,    28,    37,    38,    40,    41,    65,    67,
      68,    69,    65,    28,    28,    28,    30,     5,    24,    25,
      24,    29,    46,    60,    52,    69,    65,    68,    68,    28,
      10,    14,    31,    32,    33,    34,    35,    36,    37,    38,
      66,    15,    17,    39,    13,    51,    65,    75,    76,    75,
      65,    63,    52,    59,    61,    24,    29,    75,    63,    68,
      68,    68,    67,    69,    69,    69,    63,    29,    29,    27,
      29,    60,    29,    11,    65,    63
};
...
#line 183 "src/rascal.y"
        ...
        free((yyvsp[-3].sval));
        delete (yyvsp[-2].vec_decl_var); delete (yyvsp[0].ptr_dados_bloco);
    }
#line 1679 "src/rascal.tab.c"
    break;

  case 21: /* funcao: T_FUNCTION T_ID parametros_gerais_subrotina T_COLON tipo T_SEMICOLON bloco_subrotina  */
#line 198 "src/rascal.y"
                                                                                                  {
...
#line 1775 "src/rascal.tab.c"
    break;

  case 31: /* comando: atribuicao  */
#line 254 "src/rascal.y"
                     { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1781 "src/rascal.tab.c"
    break;

  case 32: /* comando: chamada_procedimento  */
#line 255 "src/rascal.y"
                               { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1787 "src/rascal.tab.c"
    break;

  case 33: /* comando: condicional  */
#line 256 "src/rascal.y"
                      { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1793 "src/rascal.tab.c"
    break;

  case 34: /* comando: repeticao  */
#line 257 "src/rascal.y"
                    { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1799 "src/rascal.tab.c"
    break;

  case 35: /* comando: leitura  */
#line 258 "src/rascal.y"
                  { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1805 "src/rascal.tab.c"
    break;

  case 36: /* comando: escrita  */
#line 259 "src/rascal.y"
                  { (yyval.ptr_comando) = (yyvsp[0].ptr_comando); }
#line 1811 "src/rascal.tab.c"
    break;

  case 37: /* comando: comando_composto  */
#line 260 "src/rascal.y"
                           { (yyval.ptr_comando) = (yyvsp[0].ptr_bloco_cmd); }
#line 1817 "src/rascal.tab.c"
    break;

  case 38: /* comando: %empty  */
#line 261 "src/rascal.y"
                      { (yyval.ptr_comando) = nullptr; }
#line 1823 "src/rascal.tab.c"
    break;

  case 39: /* atribuicao: T_ID T_ATRIB expressao  */
#line 263 "src/rascal.y"
                                        {
        (yyval.ptr_comando) = new CmdAtribuicao((yyvsp[-2].sval), (yyvsp[0].ptr_expr));
        free((yyvsp[-2].sval));
    }
#line 1832 "src/rascal.tab.c"
    break;

  case 40: /* expressao: expressao_simples  */
#line 268 "src/rascal.y"
                                 { (yyval.ptr_expr) = (yyvsp[0].ptr_expr); }
#line 1838 "src/rascal.tab.c"
    break;

  case 41: /* expressao: expressao_simples relacao expressao_simples  */
#line 269 "src/rascal.y"
                                                           {
                 (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), (TipoOperacao)(yyvsp[-1].ival), (yyvsp[0].ptr_expr));
             }
#line 1846 "src/rascal.tab.c"
    break;

  case 42: /* relacao: T_IGUAL  */
#line 274 "src/rascal.y"
                  { (yyval.ival) = OP_IGUAL; }
#line 1852 "src/rascal.tab.c"
    break;

  case 43: /* relacao: T_DIFERENTE  */
#line 275 "src/rascal.y"
                      { (yyval.ival) = OP_DIFERENTE; }
#line 1858 "src/rascal.tab.c"
    break;

  case 44: /* relacao: T_MENOR  */
#line 276 "src/rascal.y"
                  { (yyval.ival) = OP_MENOR; }
#line 1864 "src/rascal.tab.c"
    break;

  case 45: /* relacao: T_MENORIGUAL  */
#line 277 "src/rascal.y"
                       { (yyval.ival) = OP_MENOR_IGUAL; }
#line 1870 "src/rascal.tab.c"
    break;

  case 46: /* relacao: T_MAIOR  */
#line 278 "src/rascal.y"
                  { (yyval.ival) = OP_MAIOR; }
#line 1876 "src/rascal.tab.c"
    break;

  case 47: /* relacao: T_MAIORIGUAL  */
...
#line 282 "src/rascal.y"
                { (yyval.ptr_expr) = (yyvsp[0].ptr_expr); }
#line 1888 "src/rascal.tab.c"
    break;

  case 49: /* expressao_simples: T_MAIS termo  */
#line 283 "src/rascal.y"
                       { (yyval.ptr_expr) = (yyvsp[0].ptr_expr);}
#line 1894 "src/rascal.tab.c"
    break;

  case 50: /* expressao_simples: T_MENOS termo  */
#line 284 "src/rascal.y"
                        { (yyval.ptr_expr) = new ExprUnaria(OP_SUB, (yyvsp[0].ptr_expr)); }
#line 1900 "src/rascal.tab.c"
    break;

  case 51: /* expressao_simples: expressao_simples T_MAIS termo  */
#line 285 "src/rascal.y"
                                         { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_ADD, (yyvsp[0].ptr_expr)); }
#line 1906 "src/rascal.tab.c"
    break;

  case 52: /* expressao_simples: expressao_simples T_MENOS termo  */
#line 286 "src/rascal.y"
                                          { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_SUB, (yyvsp[0].ptr_expr)); }
#line 1912 "src/rascal.tab.c"
    break;

  case 53: /* expressao_simples: expressao_simples T_OR termo  */
#line 287 "src/rascal.y"
                                       { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_OR, (yyvsp[0].ptr_expr)); }
#line 1918 "src/rascal.tab.c"
    break;

  case 54: /* termo: fator  */
#line 290 "src/rascal.y"
                { (yyval.ptr_expr) = (yyvsp[0].ptr_expr); }
#line 1924 "src/rascal.tab.c"
    break;

  case 55: /* termo: termo T_VEZES fator  */
#line 291 "src/rascal.y"
                              { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_MUL, (yyvsp[0].ptr_expr)); }
#line 1930 "src/rascal.tab.c"
    break;

  case 56: /* termo: termo T_DIV fator  */
#line 292 "src/rascal.y"
                            { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_DIV, (yyvsp[0].ptr_expr)); }
#line 1936 "src/rascal.tab.c"
    break;

  case 57: /* termo: termo T_AND fator  */
#line 293 "src/rascal.y"
                            { (yyval.ptr_expr) = new ExprBinaria((yyvsp[-2].ptr_expr), OP_AND, (yyvsp[0].ptr_expr)); }
#line 1942 "src/rascal.tab.c"
    break;
...
#line 1951 "src/rascal.tab.c"
    break;

  case 59: /* fator: T_ID T_LPAREN lista_expressoes_vazio T_RPAREN  */
...
#line 1961 "src/rascal.tab.c"
    break;

  case 60: /* fator: T_NUM  */
#line 305 "src/rascal.y"
                { (yyval.ptr_expr) = new ExprValorInteiro((yyvsp[0].ival)); }
#line 1967 "src/rascal.tab.c"
    break;

  case 61: /* fator: T_TRUE  */
#line 306 "src/rascal.y"
                 { (yyval.ptr_expr) = new ExprValorBool(true); }
#line 1973 "src/rascal.tab.c"
    break;

  case 62: /* fator: T_FALSE  */
#line 307 "src/rascal.y"
                  { (yyval.ptr_expr) = new ExprValorBool(false); }
#line 1979 "src/rascal.tab.c"
    break;

  case 63: /* fator: T_LPAREN expressao T_RPAREN  */
#line 308 "src/rascal.y"
                                      { (yyval.ptr_expr) = (yyvsp[-1].ptr_expr); }
#line 1985 "src/rascal.tab.c"
    break;

  case 64: /* fator: T_NOT fator  */
#line 309 "src/rascal.y"
                      { (yyval.ptr_expr) = new ExprUnaria(OP_NOT, (yyvsp[0].ptr_expr)); }
#line 1991 "src/rascal.tab.c"
    break;

  case 65: /* chamada_procedimento: T_ID T_LPAREN lista_expressoes_vazio T_RPAREN  */
...
#line 2001 "src/rascal.tab.c"
  ...
  case 66: /* condicional: T_IF expressao T_THEN comando  */
#line 318 "src/rascal.y"
                                                              {
            (yyval.ptr_comando) = new CmdIf((yyvsp[-2].ptr_expr), (yyvsp[0].ptr_comando), nullptr);
        }
#line 2009 "src/rascal.tab.c"
    break;

  case 67: /* condicional: T_IF expressao T_THEN comando T_ELSE comando  */
...
#line 2017 "src/rascal.tab.c"
  ...
  case 68: /* repeticao: T_WHILE expressao T_DO comando  */
#line 325 "src/rascal.y"
                                               {
        (yyval.ptr_comando) = new CmdWhile((yyvsp[-2].ptr_expr), (yyvsp[0].ptr_comando));
    }
#line 2025 "src/rascal.tab.c"
    break;

  case 69: /* leitura: T_READ T_LPAREN lista_identificadores T_RPAREN  */
#line 329 "src/rascal.y"
                                                            {
        (yyval.ptr_comando) = new CmdRead(*(yyvsp[-1].vec_str));
        delete (yyvsp[-1].vec_str);
    }
#line 2034 "src/rascal.tab.c"
    break;

  case 70: /* escrita: T_WRITE T_LPAREN lista_expressoes_vazio T_RPAREN  */
#line 334 "src/rascal.y"
                                                               {
        (yyval.ptr_comando) = new CmdWrite(*(yyvsp[-1].vec_expr));
        delete (yyvsp[-1].vec_expr);
    }
#line 2043 "src/rascal.tab.c"
    break;

  case 71: /* lista_expressoes_vazio: %empty  */
#line 340 "src/rascal.y"
                      { (yyval.vec_expr) = new std::vector<Expressao*>(); }
#line 2049 "src/rascal.tab.c"
    break;

  case 72: /* lista_expressoes_vazio: lista_expressoes  */
#line 341 "src/rascal.y"
                           { (yyval.vec_expr) = (yyvsp[0].vec_expr); }
#line 2055 "src/rascal.tab.c"
    break;

  case 73: /* lista_expressoes: expressao  */
#line 344 "src/rascal.y"
                    {
            (yyval.vec_expr) = new std::vector<Expressao*>();
            (yyval.vec_expr)->push_back((yyvsp[0].ptr_expr));
        }
#line 2064 "src/rascal.tab.c"
    break;

  case 74: /* lista_expressoes: lista_expressoes T_VIRGULA expressao  */
#line 348 "src/rascal.y"
                                               {
            (yyval.vec_expr) = (yyvsp[-2].vec_expr);
            (yyval.vec_expr)->push_back((yyvsp[0].ptr_expr));
        }
#line 2073 "src/rascal.tab.c"
    break;


#line 2077 "src/rascal.tab.c"
